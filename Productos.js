const productos = [
    {
      ...
      imagen: "Imagenes/Candogas_Domenica.jpg",
      category: 'Candongas',
      stock: 10,
    ...
    },
    {
      ...
      imagen: "Imagenes/Candongas_Serena.jpg",
      category: 'Candongas',
      stock: 8,
      colores: ["Dorado", "Plateado"],
      material: "Rodio",
    ...
    },
    {
      ...
      imagen: "Imagenes/Candongas_Mirabella_Gold.jpg",
      category: 'Candongas',
      stock: 5,
      colores: ["Dorado"],
      material: "Rodio",
    ...
    },
    {
      ...
      imagen: "Imagenes/Candongas_Protectora_Mini_Silver.jpg",
      category: 'Candongas',
      stock: 11,
      colores: ["Plateado"],
      material: "Rodio",
    ...
    },
    {
      ...
      imagen: "Imagenes/Set_Cadenas_Super_Woman.jpg",
      category: 'Cadenas',
      stock: 4,
      colores: ["Dorado", "Plateado"],
    ...
    },
    {
      ...
      imagen: "Imagenes/Cadena_Muse_Silver.jpg",
      category: 'Cadenas',
      stock: 7,
      colores: ["Plateado"],
    ...
    },
    {
      ...
      imagen: "Imagenes/Choker_Irina_Silver.jpg",
      category: 'Chokers',
      stock: 5,
      colores: ["Plateado"],
      material: "Aleación con baño en Plata  (El acabado es vintage, algunos tienen textura)",
    ...
    },
    {
      ...
      imagen: "Imagenes/Cadena_Nicoletta.jpg",
      category: 'Cadenas',
      stock: 6,
      colores: ["Dorado", "Plateado"],
      material: "Rodio",
    ...
    },
    {
      ...
      imagen: "Imagenes/set_cadenas_priscilla.jpg",
      category: 'Cadenas',
      stock: 10,
      colores: ["Dorado", "Plateado"],
      material: "Rodio",
    ...
    },
    {
      ...
      imagen: "Imagenes/Choker_Aria_Gold.jpg",
      category: 'Chokers',
      stock: 8,
      colores: ["Dorado"],
      material: "Aleación con baño en Oro 24k (El acabado es vintage, algunos tienen textura)",
    ...
    },
    {
      ...
      imagen: "Imagenes/Earcuff_Magia_Silver.jpg",
      category: 'Earcuffs',
      stock: 6,
      colores: ["Plateado"],
      material: "Aleación con baño en Plata (El acabado es vintage, algunos tienen textura",
    ...
    },
    {
      ...
      imagen: "Imagenes/Candongas_Maxi_Cora_Gold.jpg",
      category: 'Candongas',
      stock: 7,
      colores: ["Dorado"],
    ...
    },
    {
      ...
      imagen: "Imagenes/Aretes_Curiosa_Silver.jpg",
      category: 'Aretes',
      stock: 9,
      colores: ["Plateado"],
      material: "Aleación con baño en Plata (El acabado es vintage, algunos tienen textura)",
    ...
    },
    {
      ...
      imagen: "Imagenes/Candongas_Caterina.jpg",
      category: 'Candongas',
      stock: 11,
      colores: ["Dorado", "Plateado"],
      material: "Rodio",
    ...
    },
    {
      ...
      imagen: "Imagenes/Choker_Veronica_Silver.jpg",
      category: 'Chokers',
      stock: 3,
      colores: ["Plateado"],
      material: "Aleación con baño en Plata  (El acabado es vintage, algunos tienen textura)",
    ...
    },
    {
      ...
      imagen: "Imagenes/Pulsera_Poderosa_Silver.jpg",
      category: 'Pulseras',
      stock: 6,
      colores: ["Plateado"],
      material: "Aleación con baño en Plata (El acabado es vintage, algunos tienen textura)",
